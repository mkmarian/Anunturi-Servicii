...
<head>
    ...
    <title>500 — Eroare server · MeseriiRo</title>
...
<body class="font-sans antialiased bg-gray-50 min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div class="text-center max-w-md">
        <p class="text-8xl font-extrabold text-gray-400">500</p>
        <h1 class="mt-4 text-2xl font-bold text-gray-900">Eroare de server</h1>
        <p class="mt-2 text-gray-500">
            Ceva nu a funcționat corect. Încearcă din nou în câteva momente.
        </p>
        <div class="mt-8">
            <a href="{{ route('home') }}"
